...
<body class="introbody">
    ...
    <main class="intromain">
        ...
        <div class="intro">
            <div class="introbaby1 introdis">
                <img class="f1img" src="IMG/image_01 (5).jpg" alt="">
            </div>
            <div class="introbaby2">
                <span>
                   ...
                   * 바비큐 그릴/도구 대여 및 음식 주문 이용료 안내</br>
                    ...
                    ※ 바비큐 서비스 주문은 캠핑장 예약 후 마이페이지 메뉴에서 하실 수 있습니다.</br>
                </span>
            </div>
        </div>
        <div class="cam">
        ...
        <div class="intro">
            <div class="introbaby2">
                <img class="f2img" src="IMG/image_01 (17).jpg" alt="">
            </div>
            <div class="introbaby1 f2">
                <span class="introdis">
                    * 출입</br>
                    ...
                    * 긴급사태</br>
                     - 위급을 요하는 경우와 호우 · 강풍 등으로 피난이 필요한 경우 관리자의 지시에 따라 주시기 바랍니다.</br>
                </span>
            </div>
        </div>
        <div class="cam">
